...
const appointments = [
    ...
    },
    {
        ...
        duration: '55 min',
        notes: 'Personal assistance and training session with Liam Brown'
    },
    {
        id: 7,
    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <div class="relative flex-1">
                    ...
                    <input
                        type="text"
                        id="searchInput"
                        placeholder="Search by trainer, specialty, or department..."
        ...
        <div class="mt-8 bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="text-center">
                    <div class="text-2xl font-bold text-blue-600" id="confirmedCount">0</div>
...
function generateAppointmentCards() {
    ...
    appointments.forEach(appointment => {
        ...
        card.setAttribute('data-trainer', appointment.Trainer.toLowerCase());
            ...
            <div class="p-6">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900">${appointment.Trainer}</h3>
...
function filterAppointments() {
    ...
    appointmentCards.forEach(card => {
        ...
        const matchesSearch = trainer.includes(searchTerm) || specialty.includes(searchTerm) || department.includes(searchTerm);
...
function updateSummaryCounts() {
    ...
    let counts = { completed: 0, confirmed: 0, pending: 0, cancelled: 0 };
